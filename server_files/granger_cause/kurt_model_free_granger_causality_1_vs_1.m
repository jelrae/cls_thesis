...
% ptic('starting\n')
% 
% load('/home/jordan/neuro_thesis/data/monkey_pele_data/bipolar_post_data/kurt_p_all_AttIn.mat')
% monkey = 'kurt';
...
% Use if we want to replicate the bastos
...
clear all_attention;
save(sprintf('/home/12297127/cls_thesis/server_files/results/%s_all_att_model_free_gc_one_v_one', monkey));